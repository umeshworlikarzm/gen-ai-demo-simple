...
function loadSampleData() {
    // Populate actual rows for every Thursday between 12 Feb 2026 and 23 Apr 2026
...
function loadUserProvidedDates() {
    ...
    document.getElementById('estDate').value = '2026-04-23';
    document.getElementById('totalPackages').value = total;
    const tbody = document.querySelector('#actualTable tbody');
    tbody.innerHTML = '';
    let cum = 0;
...
function renderBurndown() {
    ...
    burndownChart = new Chart(ctx, {
        ...
        options: {
            ...
            plugins: {
                title: { display: true, text: 'Security Remediation - Burndown Chart (bnet-hydra-gsp bnet-nats cdp-serve)' },
...
function exportChartPNG() {
    ...
    a.href = url;
    a.download = 'Python-burndown.png';
